  ...
  return (
    <>
      {createPortal(
        <form
          className={clsx(
            'fixed top-1/2 left-1/2 z-[5] flex flex-col items-start w-[400px] max-w-[500px] p-4 mx-auto overflow-hidden bg-white rounded-lg shadow-lg -translate-x-1/2 -translate-y-1/2 max-[420px]:max-w-[300px] max-[300px]:max-w-[240px]',
            className
          )}
          onSubmit={onSubmit}
        >
